...
- Bash 4.x+ (POSIX-compatible shell script) + openssl (RS256 JWT signing), curl (GitHub API calls), jq (JSON parsing), envman (Bitrise environment management - pre-installed) (001-github-apps-token)
